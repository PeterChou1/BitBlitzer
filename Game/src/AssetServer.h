...
public:
     ...
     */
    static ShaderAsset defaultShader;
...
private:
    ...
    std::string LookUpFilePath(ObjAsset asset)
    {
        ...
        case SpotFront:
            return "./Assets/spotFrontFace.obj";
        case Robot:
        ...
        case MetalCube:
            return "./Assets/UnitCubeMetal.obj";
        default:
    ...
    SIMDShader* LookUpShader(ShaderAsset asset)
    {
        ...
        static RedShaderSIMD RedShaderInstance = RedShaderSIMD();

        if (asset == DefaultShader)
            asset = defaultShader;
